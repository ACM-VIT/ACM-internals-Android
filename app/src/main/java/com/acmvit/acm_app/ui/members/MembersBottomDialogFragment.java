...
public class MembersBottomDialogFragment extends BottomSheetDialogFragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        binding = DialogBottomMembersBinding.inflate(inflater, container, false);
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        viewModel = new ViewModelProvider(this,
                new BaseViewModelFactory((BaseActivity) getActivity())).get(MembersBottomViewModel.class);
    ...
    private void initRv() {
        ...
        viewModel.getFilteredUsers().observe(getViewLifecycleOwner(), adapter::submitList);
        adapter.setOnItemClickListener(pos -> {
            navController.getPreviousBackStackEntry()
                    .getSavedStateHandle().set(RESULT_KEY, adapter.getCurrentList().get(pos));
        ...
        adapter.registerAdapterDataObserver(new RecyclerView.AdapterDataObserver() {
            ...
            public void onItemRangeInserted(int positionStart, int itemCount) {
                int firstVisiblePos = ((LinearLayoutManager)binding.membersRv.getLayoutManager()).findFirstCompletelyVisibleItemPosition();
        ...
        binding.membersRv.setLayoutManager(new LinearLayoutManager(getContext()));
