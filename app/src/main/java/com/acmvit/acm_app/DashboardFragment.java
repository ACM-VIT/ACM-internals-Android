...
public class DashboardFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        ideaArrayList.add(new Idea(R.drawable.today_bookings_profile_pic,"Agniva Si","12/12/2020",false,30,"Topic name",getString(R.string.dashboard_fake_description)));
        ideaArrayList.add(new Idea(R.drawable.today_bookings_profile_pic,"Agniva Si","12/12/2020",false,30,"Topic name",getString(R.string.dashboard_fake_description)));
        ideaArrayList.add(new Idea(R.drawable.today_bookings_profile_pic,"Agniva Si","12/12/2020",false,30,"Topic name",getString(R.string.dashboard_fake_description)));
        ideaArrayList.add(new Idea(R.drawable.today_bookings_profile_pic,"Agniva Si","12/12/2020",false,30,"Topic name",getString(R.string.dashboard_fake_description)));
        ideaArrayList.add(new Idea(R.drawable.today_bookings_profile_pic,"Agniva Si","12/12/2020",false,30,"Topic name",getString(R.string.dashboard_fake_description)));

        currentProjectsArrayList.add(new Idea(R.drawable.today_bookings_profile_pic,"Agniva Si","12/12/2020",false,30,"Topic name",getString(R.string.dashboard_fake_description)));
        currentProjectsArrayList.add(new Idea(R.drawable.today_bookings_profile_pic,"Agniva Si","12/12/2020",false,30,"Topic name",getString(R.string.dashboard_fake_description)));
        currentProjectsArrayList.add(new Idea(R.drawable.today_bookings_profile_pic,"Agniva Si","12/12/2020",false,30,"Topic name",getString(R.string.dashboard_fake_description)));
        currentProjectsArrayList.add(new Idea(R.drawable.today_bookings_profile_pic,"Agniva Si","12/12/2020",false,30,"Topic name",getString(R.string.dashboard_fake_description)));
        currentProjectsArrayList.add(new Idea(R.drawable.today_bookings_profile_pic,"Agniva Si","12/12/2020",false,30,"Topic name",getString(R.string.dashboard_fake_description)));

        allProjectsArrayList.add(new Idea(R.drawable.today_bookings_profile_pic,"Agniva Si","12/12/2020",false,30,"Topic name",getString(R.string.dashboard_fake_description)));
        allProjectsArrayList.add(new Idea(R.drawable.today_bookings_profile_pic,"Agniva Si","12/12/2020",false,30,"Topic name",getString(R.string.dashboard_fake_description)));
        allProjectsArrayList.add(new Idea(R.drawable.today_bookings_profile_pic,"Agniva Si","12/12/2020",false,30,"Topic name",getString(R.string.dashboard_fake_description)));
        allProjectsArrayList.add(new Idea(R.drawable.today_bookings_profile_pic,"Agniva Si","12/12/2020",false,30,"Topic name",getString(R.string.dashboard_fake_description)));
        allProjectsArrayList.add(new Idea(R.drawable.today_bookings_profile_pic,"Agniva Si","12/12/2020",false,30,"Topic name",getString(R.string.dashboard_fake_description)));
            ...
            public void onPageSelected(int position) {
                ...
                switch (position) {
                    case 0:
                        ...
                        line_1.setBackgroundColor(ContextCompat.getColor(getActivity().getApplicationContext(), R.color.colorBlue));
                        line_2.setBackgroundColor(ContextCompat.getColor(getActivity().getApplicationContext(), R.color.darkGrey));
                        line_3.setBackgroundColor(ContextCompat.getColor(getActivity().getApplicationContext(), R.color.darkGrey));
                    ...
                    case 1:
                        ...
                        line_1.setBackgroundColor(ContextCompat.getColor(getActivity().getApplicationContext(), R.color.darkGrey));
                        line_2.setBackgroundColor(ContextCompat.getColor(getActivity().getApplicationContext(), R.color.colorBlue));
                        line_3.setBackgroundColor(ContextCompat.getColor(getActivity().getApplicationContext(), R.color.darkGrey));
                    ...
                    case 2:
                        ...
                        line_1.setBackgroundColor(ContextCompat.getColor(getActivity().getApplicationContext(), R.color.darkGrey));
                        line_2.setBackgroundColor(ContextCompat.getColor(getActivity().getApplicationContext(), R.color.darkGrey));
                        line_3.setBackgroundColor(ContextCompat.getColor(getActivity().getApplicationContext(), R.color.colorBlue));
    ...
    private void fetchDataAll() {
        viewPager.setAdapter(new DashboardViewPagerAdapter(DashboardFragment.this, ideaArrayList, currentProjectsArrayList, allProjectsArrayList));
    }
}