...
public class PaginatedResource<T> {
    ...
    public PaginatedResource(@NonNull LiveData<PagedList<T>> data, @NonNull LiveData<Status> status, @NonNull Runnable invalidate, @NonNull Runnable requestAgain) {
        this();
    ...
    public void updatePaginatedResource(PaginatedResource<T> paginatedResource) {
