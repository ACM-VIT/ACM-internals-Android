...
public abstract class NetworkBoundResource<RequestType, ResultType> {
            ...
            switch (Objects.requireNonNull(apiResponse.getValue()).status) {
                ...
                case ERROR:
                    ...
                    result.addSource(dbSource,
                            newData -> result.setValue(Resource.error(response.getMessage(), newData)));
                    break;
    ...
    protected abstract void createCall(MutableLiveData<Resource<RequestType>> reqItem);

    protected  boolean shouldFetch(ResultType data) {return true;};
